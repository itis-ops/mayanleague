...
interface ProgramPageNavSheetProps {
  activeHref: string
  links: ReadonlyArray<{ label: string; href: string }>
}

export default function ProgramPageNavSheet({ activeHref, links }: ProgramPageNavSheetProps) {
  const sheetId = useId()
  ...
  const copy =
    lang === 'es'
      ? {
          trigger: 'Menú',
          title: uiCopy.es.programs,
          close: 'Cerrar',
        }
      : {
          trigger: 'Menu',
          title: uiCopy.en.programs,
          close: 'Close',
        }
