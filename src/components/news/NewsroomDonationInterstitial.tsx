...
export default function NewsroomDonationInterstitial() {
  ...
  return (
    <div className="border-y border-earth-red bg-earth-red px-5 py-12 text-white sm:px-10 sm:py-14 lg:grid lg:grid-cols-[1fr_auto] lg:items-center lg:gap-12 lg:px-12 lg:py-14">
      <div>
